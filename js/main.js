...
//         roleSaylari.admin++;
//       } else if (person.role === "moderator") {
//         roleSaylari.moderator++;
//       }
//     });
  
//     var result = [
//       "User sayı: " + roleSaylari.user,
//       "Admin sayı: " + roleSaylari.admin,
//       "Moderator sayı: " + roleSaylari.moderator
//     ];
...
// function accountingIscileriniSec() {
//     var accountingIscileri = users.filter(function(person) {
//       return person.company.department === "Accounting";
//     });
  
//     console.log(accountingIscileri);
//     return accountingIscileri;
//   }
  
  
//   accountingIscileriniSec(users);
  
// 4) emailde gmail.com ile bitenleri secib bir arraya yigan func yazin 

// function gmailIleBitenleriSec(array) {
//     var gmailEmails = array.filter(function(person) {
//       return person.email.endsWith("@gmail.com");
//     });
